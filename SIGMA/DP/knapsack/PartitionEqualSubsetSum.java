...
public class PartitionEqualSubsetSum {
    //here the thing is that we cant partition the array which is having the sum is odd we only need even so that we can partition total/2 so then half array will give the total/2 and half will total /2
